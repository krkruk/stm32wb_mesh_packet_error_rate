...
Wpływ na taki rezultat może mieć zarówno środowisko, sposób wykonywania eksperyment jak i~również ograniczenia
sprzętowe
...
% nachylenie wykresu a wpływ na ilość węzłów
\begin{figure}[!htb]
