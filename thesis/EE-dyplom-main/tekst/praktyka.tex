...
\begin{figure}[!ht]
	\centering \includegraphics[width=0.618\linewidth]{app_device_selector.png}
...
\begin{figure}[!ht]
	\centering \includegraphics[width=0.618\linewidth]{app_calibration.png}
	\caption{Selektor portów szeregowych w aplikacji służącej eksperymentowi PER.}
...
\begin{figure}[!ht]
	\centering \includegraphics[width=0.618\linewidth]{app_per_measurement.png}
