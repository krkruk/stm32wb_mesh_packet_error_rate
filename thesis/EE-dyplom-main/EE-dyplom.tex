...
\engtitle{New Features of Bluetooth 5 in Internet of Things Applications}
\album{301140}
...
providing a new set of features, increasing throughput and range while it simulanously
...
the terminology for a given set of technology stacks and compares them
...
each of said stack. These parameters include but not limited to -- latency, throughput
...
All the experiments are based on a commercial off-the-shelf development board -- \textit{P-NUCLEO-WB55}.
